...
public class DeviceRoutesDAO implements IDAO<DeviceRoutes> {
    ...
    public static void main(String[] args) {
        ...
        DeviceRoutes deviceRoutes = new DeviceRoutes(new Device("devid", "T"));
        Route r = new Route(new Detector(1), (new Detector(2)));
        LocalDateTime localDateTime = LocalDateTime.parse("2014-05-10T10:30");
        deviceRoutes.addRoute(localDateTime, r);

        deviceRoutesDAO.createOrUpdate(deviceRoutes);

        Route r1 = new Route(new Detector(2), (new Detector(3)));
        LocalDateTime localDateTime1 = LocalDateTime.parse("2014-05-10T10:30");
        deviceRoutes.addRoute(localDateTime1, r1);
